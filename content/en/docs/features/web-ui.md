...
- **Options and commands access**: Use the sidebar for commands and options, including opening interactive terminals, logs, subagents, and more.
...
{{< callout >}}
The Pando Web-UI is fully responsive and adapts to any screen size, providing an optimal experience on desktop and mobile.
{{< /callout >}}
